(() => {
  ...
  // STEP WANGAN-BIZ-8: 本番公開前の受付情報整理・追跡URL分離
  ...
  const DRAFT_KEY = `wanganBiz8Draft:${SHOP_CODE}`;
  const REQUEST_KEY = `wanganBiz8RequestId:${SHOP_CODE}`;
  ...
  console.info('WANGAN-BIZ-8 production-ready reception active');
  if (els.envChip) {
